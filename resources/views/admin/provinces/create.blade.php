...
@section('content')
    <div class="px-4">
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Thêm tỉnh mới</h2>
            </div>
            <div class="my-4">
                <form method="POST" action="{{ route('provinces.store') }}">
                    @csrf
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700">Tên tỉnh</label>
                    ...
                    <div class="flex items-center justify-end">
                        ...
                        <a href="{{ route('provinces.index') }}" class="ml-4 text-gray-600 hover:text-gray-800">Trở Lại</a>
                    </div>
                </form>
            </div>
        </div>
